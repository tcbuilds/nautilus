...
> Phase 1 of the playbook ships framing only. This index and the per-skill detail files under `skills/` will populate as artifacts mature and earn their place across multiple projects.
